...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Toggle */}
      <div className={`flex p-4 ${collapsed ? "justify-center" : "justify-end"}`}>
        <button
      ...
      <div className={`p-4 ${collapsed ? "px-2" : "px-4"}`}>
        ...
        >
          {!collapsed && (
            <>
              <p className="text-sm font-semibold text-center">Upgrade to Pro</p>
      ...
      <div className="p-4">
        ...
        >
          ...
          {!collapsed && (
            <span className="transition-all duration-300 group-hover:text-red-100 group-hover:font-medium">Logout</span>
          )}
        </div>
      </div>
    </div>
...
function DashboardIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function TransactionsIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M4 4h16v4H4V4zm0 6h16v4H4v-4zm0 6h10v4H4v-4z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function ReportsIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M3 3h18v18H3V3zm5 14l3-4 2 3 4-6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function SettingsIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M12 15.5c-1.9 0-3.5-1.6-3.5-3.5S10.1 8.5 12 8.5s3.5 1.6 3.5 3.5-1.6 3.5-3.5 3.5z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M19.4 13c.1-.3.1-.7.1-1s0-.7-.1-1l2.1-1.6c.2-.2.3-.5.2-.8l-2-3.4c-.1-.3-.5-.4-.8-.3l-2.5 1a6.4 6.4 0 00-1.6-1l-.4-2.7a.7.7 0 00-.7-.5h-3.4a.7.7 0 00-.7.5l-.4 2.7a6.4 6.4 0 00-1.6 1l-2.5-1a.7.7 0 00-.8.3l-2 3.4c-.1.3 0 .6.2.8l2.1 1.6c-.1.3-.1.7-.1 1s0 .7.1 1l-2.1 1.6c-.2.2-.3.5-.2.8l2 3.4c.1.3.5.4.8.3l2.5-1c.5.4 1 .7 1.6 1l.4 2.7c.1.3.4.5.7.5h3.4c.3 0 .6-.2.7-.5l.4-2.7c.6-.2 1.1-.6 1.6-1l2.5 1c.3.1.6 0 .8-.3l2-3.4c.1-.3 0-.6-.2-.8L19.4 13z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function LogoutIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      <path d="M16 17l5-5m0 0l-5-5m5 5H9M13 21v-2M13 5V3M13 3H5a2 2 0 00-2 2v14a2 2 0 002 2h8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}